{
  inputs =
    let
      version = "1.10.0";
system = "x86_64-linux";
devenv_root = "/home/esdevries/lms/2d-new-graduation/02-graduation-project";
devenv_dotfile = "/home/esdevries/lms/2d-new-graduation/02-graduation-project/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-84a0c8d";
...
hostname = "redmi";
username = "esdevries";
git_root = "/home/esdevries/lms/2d-new-graduation/02-graduation-project";
